...
class SimpleRegisterScreen extends StatefulWidget {
  final Function(String? email, String? password, String? fullName, String? address, double? height, double? weight, int? age)? onSubmitted;
...
class _SimpleRegisterScreenState extends State<SimpleRegisterScreen> {
  ...
  int? age;
  String? emailError, passwordError;
  Function(String? email, String? password, String? fullName, String? address, double? height, double? weight, int? age)? get onSubmitted =>
      widget.onSubmitted;
  ...
  bool validate() {
    ...
    if (fullName.isEmpty || address.isEmpty || height == 0.0 || weight == 0.0 || age == 0) {
      // Handle validation for additional parameters
      isValid = false;
    }
